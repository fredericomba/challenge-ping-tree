...
var createMainServer = require('./main-server')

var mainServer = createMainServer()

router.set('/favicon.ico', empty)
router.set('/health', health)
router.set('/api/targets', mainServer.handlers.targets)
router.set('/api/target/:id', mainServer.handlers.singleTarget)
router.set('/route', mainServer.handlers.route)
